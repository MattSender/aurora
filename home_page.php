...
<!-- Intégration CSS -->
<link rel="stylesheet" href="cssfile/home_page.css">
<link rel="stylesheet" href="cssfile/contact.css">
<link rel="stylesheet" href="cssfile/footer.css">
<link rel="stylesheet" href="cssfile/home_page_store.css">
...
<link
    ...
    />
    <link rel="stylesheet" href="cssfile/musique.css" />
...
<section class="et-hero-tabs">
  <h1>Aurora | Infinity</h1>
  <h3>Du texte ici !</h3>
  <div class="et-hero-tabs-container">
    <a class="et-hero-tab" href="#tab-es6">Store</a>
    <a class="et-hero-tab" href="#tab-flexbox">Musique</a>
    <a class="et-hero-tab" href="#tab-react">Contact</a>
  ...
  <section class="et-slide" id="tab-es6">
    ...
    <div class="product active">
      <div class="product-card">
          <div class="product-image" id="img01"> </div>
          <div class="product-info">
              <p class="product-theme">Aurora | Infinity</p>
              <h2 class="product-title">Allez à la Boutique</h2>
              <p class="product-description">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dicta porro, tempora consequuntur vel dolore assumenda aspernatur cum dignissimos unde reprehenderit sint? Neque, id consequuntur. Quibusdam sit officiis debitis corrupti. Quasi.</p>
              <a class="product-link" href="store.php">Boutique</a>
          </div>
      </div>
  </div>
...
<!-- Contact -->
  ...
  <h1 class="title">Nous Contacter</h1><br>
...
<script src="js/home_page_store.js"></script>
